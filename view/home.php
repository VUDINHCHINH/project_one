            ...
            <div class="sanphambanchay-product-top">
                ...
                foreach ($sp_banchay as $sp) {
                    ...
                    echo '<div class="box_items ' . $mr .'">
                        <a href="index.php?act=sanphamct&idsp=' . $id . '" class="product-link" data-product-id="' . $id . '"><img src="' . $hinh . '" alt="" width=200></a>
                        <div class="sub">
                            <h2>' . $name . '</h2>
                            <p>' . $price . '</p>
                        </div>
                        <div class="content-button">
                            <a href="index.php?act=sanphamct&idsp=' . $id . '"><button class="xem-chi-tiet">Xem Chi Tiết</button></a>
                        </div>
